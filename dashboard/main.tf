...
#     widget_billboard {
#       title  = var.dashboard.title[count.index]
#       row    = var.dashboard.row[count.index]
#       column = var.dashboard.column[count.index]
#       width  = var.dashboard.width[count.index]
#       height = var.dashboard.height[count.index]
